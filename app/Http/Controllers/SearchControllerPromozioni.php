...
class SearchControllerPromozioni extends Controller
{
    ...
    public function search(Request $request, $paged = 4)
    {
        ...
        // query per cercare promozioni che corrispondano ai criteri di ricerca
        ...
        e promozioni con nome o oggetto simili alla stringa 'promotionQuery'. where con la funzione
        ($query) use ($promotionQuery) costruisce una condizione complessa utilizzando l' OR */
